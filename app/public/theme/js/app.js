            ...
            if (!$(Selector.getBody).hasClass('single-page')) {
                ...
                if ($(Selector.getBody).hasClass('dashboard-analytics')) {
                    ...
                    $('#minimal').on('click', function(event) {
                        event.preventDefault();
                        /* Act on the event */
                        $html = '<link href="/theme/css/dashboard/dash_1-minimal.css" rel="stylesheet" type="text/css" class="dashboard-analytics-minimal" />';
                ...
                $('#minimal').on('click', function(event) {
                    event.preventDefault();
                    /* Act on the event */
                    $html = '<link href="/theme/css/structure-minimal.css" rel="stylesheet" type="text/css" class="structure-minimal" />';
        ...
        setcolorScheme: function() {
            if (Cookies.getCookie('minimal_theme') != "") {
                ...
                if ($(Selector.getBody).hasClass('dashboard-analytics')) {
                    ...
                    $html = '<link href="/theme/css/dashboard/dash_2-minimal.css" rel="stylesheet" type="text/css" class="dashboard-sales-minimal" />';
                    $(".dashboard-sales").after($html);
                }
